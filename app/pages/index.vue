<template>
  <div>
    <section
      class="flex flex-col lg:flex-row justify-between gap-6 sm:gap-10 md:gap-16 mb-8 md:mb-20"
    >
      <!-- content - start -->
      <div class="xl:w-5/12 flex flex-col justify-center sm:text-center lg:text-left lg:py-12">
        <h1 class="text-gray-700 text-2xl sm:text-3xl md:text-4xl font-bold mb-8 md:mb-12">
      ...
      <!-- image - start -->
      <div class="xl:w-5/12 h-48 lg:h-96">
    ...
    >
      <!-- stats - start -->
      <div class="grid grid-cols-2 md:flex md:divide-x gap-4 -mx-6 md:-mx-8 max-w-3xl">
        <div class="px-6 md:px-8">
          <span class="block text-orange-500 text-lg md:text-xl font-bold text-center md:text-left"
            >3200+</span
          >
          <span class="block text-gray-600 text-sm md:text-sm font-bold text-center md:text-left"
      ...
      <div class="flex justify-center lg:justify-start items-center gap-4">
        <span class="text-gray-600 text-sm sm:text-base font-semibold tracking-widest uppercase"
          >Social</span
        >
    ...
    <section class="my-24">
      <div class="bg-gray-200 py-8 rounded-xl">
        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
          <div
            class="flex flex-col md:flex-row items-center gap-24 text-center place-content-between px-16"
          >
            <div>
              <p class="text-gray-700 text-lg font-bold">
                Fill out the form to receive a free pet portrait!
              </p>
            </div>
            ...
            <div>
              <a
                href="#"
                class="inline-block bg-orange-500 hover:bg-orange-600 active:bg-orange-700 focus-visible:ring ring-orange-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3"
                >Request Art</a
              >
            </div>
          </div>
