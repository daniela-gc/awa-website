<template>
  <section class="portfolio px-1 md:px-4">
    <div
    ...
    >
      ...
      <div class="flex flex-col md:flex-row items-center text-center md:text-left">
        <h1
          class="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-gray-700 md:mr-12 mb-4 md:mb-0"
        >
          Portfolio
        </h1>
        <p
      ...
      <!-- social - start -->
      <div class="flex items-center justify-center md:justify-start gap-4 mt-6 md:mt-0">
        <span
          class="hidden lg:inline-block text-gray-500 text-sm lg:text-base font-semibold tracking-widest uppercase md:ml-6"
          >Social</span
        >
        <span class="hidden lg:inline-block w-8 h-px bg-gray-300"></span>
